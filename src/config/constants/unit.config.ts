import KidsFacade from '@/assets/images/units/kids-facade.jpeg'

export const UNITS = [
    {
        isKids: false,
        whatsappPhone: '',
        name: 'Colégio Papa Mike',
        telephone: '(11) 93088-3080',
        link: `https://goo.gl/maps/BDjC3zpniXjEV4EP6`,
        address: 'Rua Minas Bogasian, 350 - Centro - Osasco/SP',
        image: `https://lh5.googleusercontent.com/p/AF1QipMoZCYhHOBJwPNfg4pFkYhGb6Ot_Crp3u1Fx5Po=w600-h650-p-k-no`,
